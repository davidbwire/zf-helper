...
/**
 * Description of AfricasTalkingGateway
 *
...
class AfricasTalkingGateway
{
    ...
    public function sendMessage($to_, $message_, $from_ = null,
            $bulkSMSMode_ = 1, Array $options_ = array())
    {
        /*
    ...
    public function fetchPremiumSubscriptions($shortCode_, $keyword_,
            $lastReceivedId_)
    {
        $username = $this->_username;
    ...
    protected function setCurlOpts(&$curlHandle_)
    {
        ...
        curl_setopt($curlHandle_, CURLOPT_HTTPHEADER,
